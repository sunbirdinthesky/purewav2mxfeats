...
#    print (len(pointsource_noise_list), random.random(), pointsource_noise_addition_probability, max_noises_recording)
    ...
    if not os.path.isfile(input_dir + "/reco2dur"):
        ...
        for value in wav_scp.values():
            ...
            if "sox" in value and "speed" in value:
                ...
                break
        data_lib.RunKaldiCommand("wav-to-duration scp:{0}/wav.scp ark,t:{0}/reco2dur".format(input_dir, read_entire_file))
